...
// REST Controller điều phối các API quản lý hồ sơ thông tin cá nhân của người dùng (`/api/khach-hang`). Cung cấp: Xem danh sách thành viên (chỉ Admin), cập nhật hồ sơ cá nhân hiện tại, và tra cứu thông tin chi tiết một khách hàng theo ID kèm phân quyền bảo mật.
@RestController
...
public class KhachHangController {
    ...
    // API lấy thông tin chi tiết hồ sơ của một tài khoản cụ thể theo ID. Chứa kiểm duyệt bảo mật: - Admin xem được tất cả. - Chủ trọ xem được nếu khách hàng này đang thuê phòng thuộc quyền quản lý của chủ trọ đó. - Khách thuê chỉ xem được của chính bản thân.
