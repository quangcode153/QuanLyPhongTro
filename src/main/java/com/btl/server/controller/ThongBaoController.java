...
// REST Controller điều phối các API đăng thông báo tin tức (`/api/thong-bao`). Hỗ trợ chủ trọ đăng bài viết, nhắc nhở đóng tiền phòng và khách thuê xem danh sách thông báo.
@RestController
