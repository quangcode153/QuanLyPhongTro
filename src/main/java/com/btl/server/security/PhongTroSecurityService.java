...
// Component bảo mật tùy chỉnh (`phongTroSecurity`) dùng trong cấu hình @PreAuthorize của Controller. Giúp kiểm tra trực tiếp xem tài khoản đăng nhập hiện tại có đúng là Chủ sở hữu của căn phòng trọ hay không.
